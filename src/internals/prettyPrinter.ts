...
export class PrettyPrinter {
  ...
  ppAstMessage(struct: AstMessageDecl): string {
    const prefixFormatted = struct.opcode !== null ? `(${struct.opcode}) ` : "";
    this.increaseIndent();
    const fieldsFormatted = struct.fields
      .map((field) => this.ppAstFieldDecl(field))
      .join("\n");
  ...
  ppAstStatement(stmt: AstStatement): string {
    switch (stmt.kind) {
      ...
      case "statement_expression":
        return this.ppAstStatementExpression(stmt as AstStatementExpression);
  ...
  ppAstStatementLet(statement: AstStatementLet): string {
    ...
    const tyAnnotation =
      statement.type === null ? "" : `: ${this.ppAstType(statement.type)}`;
...
export function prettyPrint(input: AstNode): string {
  ...
  switch (input.kind) {
    ...
    case "constant_decl":
      return pp.ppAstConstDecl(input);
    case "function_def":
    ...
    case "map_type":
    case "bounced_message_type":
      return pp.ppAstType(input);
    case "primitive_type_decl":
      return pp.ppAstPrimitiveTypeDecl(input);
    case "message_decl":
      return pp.ppAstMessage(input);
    case "native_function_decl":
      return pp.ppAstNativeFunction(input);
    case "field_decl":
      return pp.ppAstFieldDecl(input);
    case "function_decl":
      return pp.ppAstFunctionDecl(input);
    case "receiver":
      return pp.ppAstReceiver(input);
    case "contract_init":
      return pp.ppAstInitFunction(input);
    case "statement_let":
      return pp.ppAstStatementLet(input);
    case "statement_return":
      return pp.ppAstStatementReturn(input);
    case "statement_expression":
      return pp.ppAstStatementExpression(input);
    case "statement_assign":
      return pp.ppAstStatementAssign(input);
    case "statement_augmentedassign":
      return pp.ppAstStatementAugmentedAssign(input);
    case "statement_condition":
      return pp.ppAstCondition(input);
    case "statement_while":
      return pp.ppAstStatementWhile(input);
    case "statement_until":
      return pp.ppAstStatementUntil(input);
    case "statement_repeat":
      return pp.ppAstStatementRepeat(input);
    case "statement_try":
      return pp.ppAstStatementTry(input);
    case "statement_try_catch":
      return pp.ppAstStatementTryCatch(input);
    case "statement_foreach":
      return pp.ppAstStatementForEach(input);
    case "struct_field_initializer":
      return pp.ppAstStructFieldInit(input);
    case "import":
      return pp.ppAstImport(input);
    default:
      throw InternalException.make("Unsupported AST type", { node: input });
  }
}
